...
Having obtained approximations for the right-hand side of \cref{eq:downsum} we solve the linear system to find the values of $\mathbf{f}^{BD}$ at the quadrature points $\mathbf{q}^{BD}$. 
