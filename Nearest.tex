...
\begin{figure}[ht!]
 \centering
 \subfloat[\label{fig:NYSTROM}]{\includegraphics[width=0.4\textwidth]{Images/NEAREST/Nystrom.pdf}}
 \subfloat[\label{fig:DIS}]{\includegraphics[width=0.4\textwidth]{Images/NEAREST/Disjoint.pdf}}\\
 \subfloat[\label{fig:JOIN}]{\includegraphics[width=0.4\textwidth]{Images/NEAREST/Intersecting.pdf}}
